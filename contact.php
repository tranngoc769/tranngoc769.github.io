...
<head>
	<!-- Title -->
	<title>My CV - Contacts</title>

	<!-- Meta -->
	<meta charset="UTF-8">
	<meta property="og:title" content="Tran Ngoc Quang CV"/> 
	...
	<meta property="og:description" content="Xem chi tiết về CV của tôi tại đây"/> 
	<meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1" />
	<meta name="description" content="Tran Ngoc Quang CV">
	<meta name="keywords" content="Tran Ngoc Quang, CV, Projects, Resume">
	<!-- Fonts -->
					...
					<div class="service-items">
						...
						<div class="service-col">
							<div class="service-item content-box">
								...
								<div class="text">+ (84) 37 858 0738</div>
							</div>
						</div>
